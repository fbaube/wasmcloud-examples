...
// EchoResponse contains request info, 
// sent back as JSON from the echo server
...
// Implementation of the `wasi-http:incoming-handler`
// export in the `echo` world (see `wit/echo.wit)`
//
// This method's signature and implementation use code generated by
// `wit-bindgen`, in the `gen` folder.
// `wash build` auto-runs `wit-bindgen` generate the classes aliased above.
func echoHandler(w http.ResponseWriter, r *http.Request) {
	...
	// building the EchoResponse object
	...
	// Send the correct content-type regardless of success or error.
	...
	logger.Debug("request diagnostics", "method", er.Method,
	"path", er.Path, "queryString", er.QueryString, "body", er.Body)
